...
public class HapticsOfAvatar : MonoBehaviour
{
    ...
    //    Avatars.Remove(Avatars[randomGender]);
    //}
    ...
    void Update()
    {
        ...
        {
            if (!IsBusy)
                HapticManager.PlayEffect(HBEffect, GameObject.Find("AvatarSpawner").GetComponent<SpawnAvatar>().LocationAvatar);
